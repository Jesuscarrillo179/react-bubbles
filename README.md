...
a token is given to a user that is unique to access their private data.

- [ ] What steps can you take in your web apps to keep your data secure?
  you can encrypt the data that is being passed though in and out.

- [ ] Describe how web servers work.
web servers are systems that host websites when requested by a user.
